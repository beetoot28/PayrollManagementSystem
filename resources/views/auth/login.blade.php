<x-guest-layout>
    <x-auth-card>
        <x-slot name="logo">
            ...
            <h4 class="mt-2 font-sans text-xl font-bold">Employee Management & Payroll Generation</h4>
        </x-slot>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="flex flex-col-reverse items-center">
                ...
                <x-button class="flex items-center my-1 mx-auto" onclick="this.disabled=true;this.form.submit();">
                    {{ __('Log in') }}
                </x-button>
            </div>
        </form>
