        ...
        <div class="p-6 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <form class="flex flex-row" action="{{ route('settings') }}" method="GET">
                    <input id="edr_search" name="edr_search" type="text" class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-md focus:ring-blue-500 focus:border-blue-500 block px-2 py-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{ request()->query('edr_search') }}" autocomplete="off">
                ...
                <button type="button" class="ml-2 px-3 py-1.5 text-sm text-white bg-blue-700 rounded-md border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" x-on:click="new_employee_dr = true"> New </button>
            </div>
                            ...
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                ...
                                <td class="flex items-center">
                                    ...
                                    {{-- <form action="{{ route('view-employee-dr', ) }}" method="GET">
                                        <input type="text" name="view_dr" value="{{ $emp_record->employee_id }}" class="hidden">
