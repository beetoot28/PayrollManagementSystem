<div class="inline-flex items-center justify-center w-full h-full z-20 top-0 absolute px-10 lg:px-20" style="display: none;" x-show="show_epayroll_details" x-transition.duration.400ms>
    <div class="w-full bg-white rounded-lg shadow-md opacity-100 p-3">
        <div class="flex justify-between pb-2 border-b-2 border-gray-200">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"
                ...
                x-on:click="show_epayroll_details = false, clear_details, (changes_detected ? location.reload() : '' )">
                <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" />
            </svg>
        </div>

        <div class="flex-col flex lg:flex-row w-full lg:space-x-2 space-y-2 lg:space-y-0 h-96 overflow-y-auto">
            <div class="flex-row w-full lg:w-1/2 h-96 overflow-y-auto">
                <div class="flex-col pt-1 space-y-1">
                    ...
                    <div class="flex flex-row justify-between bg-gray-100 hover:bg-gray-300 px-2 rounded-md py-1">
                        ...
                        <div class="flex flex-row">
                            <template x-if="payroll_status == 0">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"
                                    class="text-yellow-500 w-6 h-6 cursor-pointer hover:text-yellow-700 hover:bg-gray-300 rounded-md p-1 mr-1.5"
                                    x-on:click="update_dr = true, get_drs('Employee Dr')">
                    ...
                    <div class="flex flex-row justify-between bg-gray-100 hover:bg-gray-300 px-2 rounded-md py-1">
                        ...
                        <div class="flex flex-row">
                            <template x-if="payroll_status == 0">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"
                                    class="text-yellow-500 w-6 h-6 cursor-pointer hover:text-yellow-700 hover:bg-gray-300 rounded-md p-1 mr-1.5"
                                    x-on:click="update_dr = true, get_drs('Other Dr')">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" />
                                </svg>
                            </template>
                    ...
                    <div class="flex flex-row justify-between bg-gray-100 hover:bg-gray-300 px-2 rounded-md py-1">
                        ...
                        <div class="flex flex-row">
                            <template x-if="payroll_status == 0">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"
                                    class="text-yellow-500 w-6 h-6 cursor-pointer hover:text-yellow-700 hover:bg-gray-300 rounded-md p-1 mr-1.5"
                                    x-on:click="update_dr = true, get_drs('Due From')">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" />
                                </svg>
                            </template>
                    ...
                    <div class="flex flex-col justify-between bg-gray-100 hover:bg-gray-300 px-2 rounded-md py-1 ">
                        <div class="flex flex-row justify-between">
                            ...
                            <template x-if="payroll_status == 0">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"
                                    class="text-yellow-500 w-6 h-6 cursor-pointer hover:text-yellow-700 hover:bg-gray-300 rounded-md p-1"
                                    x-on:click="update_remarks = true, temp_remarks = remarks">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" />
                                </svg>
                            </template>
