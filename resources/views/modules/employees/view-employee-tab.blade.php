    ...
    <div class="p-6 bg-white border-b border-gray-200">
        ...
        <div class="mb-4">
            <div class="w-32 h-32 bg-gray-200 rounded-xl flex flex-row border border-gray-600">
                <div class="flex justify-center items-center mx-auto">
                    <img src="{{ asset('storage/employee/'.$employees->employee_photo) }}" alt="emp_photo">
                </div>
            </div>
        </div>
        ...
        <div class="flex flex-col lg:flex-row space-x-0 lg:space-x-5">
            ...
            <div class="mb-6 w-full">
                ...
                <input type="text" id="n_date_of_birth" name="date_of_birth1" class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" x-ref="bday" disabled value="{{ date('F j, Y', strtotime($employees->date_of_birth)) }}" autocomplete="off" x-on:click.outside="compute_age">
            </div>
...
<div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mt-2" style="display: none;" x-show="tab_3" x-transition:enter.duration.500ms>
    <div class="p-6 bg-white border-b border-gray-200">
        ...
        <div class="flex items-center mb-3">
            <input id="with_ot_pay" {{ $employees->EmployeeDetails->with_ot_pay ? 'checked' : '' }} type="checkbox" id="with_ot_pay" name="with_ot_pay" value="" class="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" disabled>
        ...
        <div class="flex flex-col lg:flex-row space-x-0 lg:space-x-5">
            ...
            <div class="mb-6 w-full">
                ...
                <select id="n_department" name="department" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" disabled value="{{ $employees->EmployeeDetails->department }}" autocomplete="off">
        ...
        <div class="flex flex-col lg:flex-row space-x-0 lg:space-x-5">
            ...
            <div class="mb-6 w-full">
                ...
                <input type="text" id="n_date_hired" name="date_hired1" class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" disabled value="{{ date('F j, Y', strtotime($employees->EmployeeDetails->date_hired)) }}" autocomplete="off">
            </div>
            <div class="mb-6 w-full">
                <label for="n_date_resigned" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Date Resigned <span class="text-red-400 text-lg">*</span></label>
                <input type="text" id="n_date_resigned" name="date_resigned1" class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" disabled value="{{ $employees->EmployeeDetails->date_resigned ? date('F j, Y', strtotime($employees->EmployeeDetails->date_resigned)) : '' }}"  autocomplete="off">
            </div>
        </div>
        ...
        <div class="flex flex-col lg:flex-row space-x-0 lg:space-x-5">
            ...
            <div class="mb-6 w-full">
                ...
                <input type="text" id="n_pagibig_no" name="pagibig_no" placeholder="1211-0000-1122" class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" disabled value="{{ $employees->EmployeeDetails->hdmf_no }}" autocomplete="off">
            </div>
        </div>
    </div>
</div>
    ...
    <div class="p-6 bg-white border-b border-gray-200">
        ...
        <div class="flex flex-col lg:flex-row space-x-0 lg:space-x-5">
            ...
            <div class="mb-6 w-full">
                ...
                <input type="number" id="n_philhealth_contribution" name="philhealth_contribution" class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" disabled value="{{ $employees->EmployeeDetails->philhealth_contribution }}" autocomplete="off">
    ...
    <div class="p-6 bg-white border-b border-gray-200">
        ...
        <div class="flex flex-col lg:flex-row space-x-0 lg:space-x-5">
            ...
            <div class="mb-6 w-full">
                ...
                <input type="text" id="n_spouse_name" name="spouse_name" class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" disabled value="{{ $employees->EmployeeDetails->spouse_name }}" autocomplete="off">
            </div>
            <div class="mb-6 w-full">
        ...
        <div class="flex flex-col lg:flex-row space-x-0 lg:space-x-5">
            ...
            <div class="mb-6 w-full">
                ...
                <input type="number" id="n_emergency_number" name="emergency_number" placeholder="09456517431" class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" disabled value="{{ $employees->EmployeeDetails->emergency_contact_no }}" autocomplete="off">
            </div>
            ...
            <div class="mb-6 w-full">
                ...
                <input type="text" id="n_contact_person_address" name="contact_person_address" class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" disabled value="{{ $employees->EmployeeDetails->emergency_contact_address }}" autocomplete="off">
            </div>
        </div>
        <div class="flex flex-col lg:flex-row space-x-0 lg:space-x-5">
            <div class="mb-6 w-full lg:w-1/2">
                ...
                <textarea type="text" id="n_dependant" name="dependant" class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" disabled x-model="dependant"  autocomplete="off">
                </textarea>
            </div>
        </div>
    </div>
