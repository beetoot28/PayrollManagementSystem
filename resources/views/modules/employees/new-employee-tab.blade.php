...
<div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mt-2" style="display: none;" x-show="tab_1" x-transition:enter.duration.500ms>
    <div class="p-6 bg-white border-b border-gray-200">
        ...
        <div class="mb-4">
            ...
            <div class="">
                <label class="w-32 h-32 bg-gray-200 rounded-xl flex flex-row border border-gray-600" x-show="!imageUrl">
                    ...
                    <img class="flex justify-center items-center mx-auto" :src="image_default">
                    <input type="file" id="emp_photo" name="emp_photo" x-ref="emp_photo" hidden x-on:change="fileChosen">
                </label>
                <label class="w-32 h-32 bg-gray-200 rounded-xl flex flex-row border border-gray-600" x-show="imageUrl">
                    <img class="flex justify-center items-center mx-auto" :src="imageUrl">
                    <input type="file" id="emp_photo" name="emp_photo" x-ref="emp_photo2" hidden x-on:change="fileChosen">
                </label>
            </div>
        </div>
        ...
        <div class="flex flex-col lg:flex-row space-x-0 lg:space-x-5">
            ...
            <div class="mb-6 w-full">
                ...
                <input datepicker  type="text" id="n_date_of_birth" name="date_of_birth" class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{ old('date_of_birth') }}" x-ref="bday" autocomplete="off" x-on:click.outside="compute_age">
            </div>
        ...
        <div class="flex flex-col lg:flex-row space-x-0 lg:space-x-5">
            ...
            <div class="mb-6 w-full">
                ...
                <select id="n_employee_status" name="employee_status" class="bg-gray-50 border border-gray-300 text-gray-900 mb-6 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" x-ref="employee_status" autocomplete="off">
                    @if (old('employee_status')) {{-- evaluate nya true or false | pag may laman true if wala false --}}
                        <option selected hidden value="{{ old('employee_status') }}">{{ old('employee_status') == 1 ? 'Regular' : 'Casual'}}</option> {{-- mag appeat ito sya pag may laman na ang old() --}}
                    @else
                        <option selected hidden value="">Choose Employee Status</option> {{-- mag appeat ito pag una una palang ibig sabihin wala pa laman si old() --}}
                    @endif
...
<div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mt-2" style="display: none;" x-show="tab_3" x-transition:enter.duration.500ms>
    <div class="p-6 bg-white border-b border-gray-200">
        ...
        <div class="flex items-center mb-3">
            ...
            <input id="with_ot_pay" :checked="{{ old('ot_pay_value') == '' ? true : old('ot_pay_value') }}" type="checkbox" id="with_ot_pay" name="with_ot_pay" value="" class="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" @click="ot_pay = !ot_pay">
        ...
        <div class="flex flex-col lg:flex-row space-x-0 lg:space-x-5">
            <div class="mb-6 w-full">
                ...
                <input type="text" id="n_employee_number" name="employee_number" class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" x-ref="employee_number" value="{{ old('employee_number') }}" autocomplete="off">
                {{-- <x-input type="text" id="n_employee_number" name="employee_number" :value="old('employee_number')" class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" /> --}}
            </div>
            ...
            <div class="mb-6 w-full">
                ...
                <select id="n_department" name="department" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{ old('department') }}" autocomplete="off">
                    @if (old('department'))
                        <option selected hidden value="{{ old('department') }}">{{ old('department') == 1 ? 'Sales Department' : (old('department') == 2 ? 'Accounting Department' : (old('department') == 3 ? 'Finance Department' : ('Logistics Department')))}}</option>
                    @else
        ...
        <div class="flex flex-col lg:flex-row space-x-0 lg:space-x-5">
            ...
            <div class="mb-6 w-full">
                ...
                <input datepicker type="text" id="n_date_hired" name="date_hired" class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{ old('date_hired') }}" autocomplete="off">
            </div>
            {{-- <div class="mb-6 w-full">
    ...
    <div class="p-6 bg-white border-b border-gray-200">
        ...
        <div class="flex flex-col lg:flex-row space-x-0 lg:space-x-5">
            ...
            <div class="mb-6 w-full">
                ...
                <input type="number" id="n_philhealth_contribution" name="philhealth_contribution" class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{ old('philhealth_contribution') }}" autocomplete="off">
        ...
        {{-- <div>
            ...
            <div class="flex flex-col lg:flex-row space-x-0 lg:space-x-5">
                <div class="mb-6 w-full">
                    <label for="n_employee_number" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Employee ID <span class="text-red-400 text-lg">*</span></label>
                    <input type="text" id="n_employee_number" name="employee_number" class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" x-ref="employee_number" autocomplete="off">
                </div>

                <div class="mb-6 w-full">
                    <label for="n_department" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Department <span class="text-red-400 text-lg">*</span></label>
                    <select id="n_department" name="department" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" x-ref="department" autocomplete="off">
                        <option selected hidden value="">Choose Department</option>
                        <option value="1">Sales Department</option>
                        <option value="2">Accounting Department</option>
                        <option value="3">Finance Department</option>
                ...
                <div class="mb-6 w-full">
                    <label for="n_basic_rate" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Basic Rate <span class="text-red-400 text-lg">*</span></label>
                    <input type="number" id="n_basic_rate" name="basic_rate" class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" x-ref="basic_rate" autocomplete="off">
                </div>
                <div class="mb-6 w-full">
                    <label for="n_allowance" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Allowance <span class="text-red-400 text-lg">*</span></label>
                    <input type="number" id="n_allowance" name="allowance" class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" x-ref="allowance" autocomplete="off">
                </div>
            </div>
        </div>
        <div>
    ...
    <div class="p-6 bg-white border-b border-gray-200">
        ...
        <div class="flex flex-col lg:flex-row space-x-0 lg:space-x-5">
            ...
            <div class="mb-6 w-full">
                ...
                <input type="text" id="n_spouse_name" name="spouse_name" class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{ old('spouse_name') }}" autocomplete="off">
            </div>
            <div class="mb-6 w-full">
        ...
        <div class="flex flex-col lg:flex-row space-x-0 lg:space-x-5">
            ...
            <div class="mb-6 w-full">
                ...
                <input type="number" id="n_emergency_number" name="emergency_number" placeholder="09456517431" class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{ old('emergency_number') }}" autocomplete="off">
            </div>
            ...
            <div class="mb-6 w-full">
                ...
                <input type="text" id="n_contact_person_address" name="contact_person_address" class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{ old('contact_person_address') }}" autocomplete="off">
            </div>
        </div>
        <div class="flex flex-col lg:flex-row space-x-0 lg:space-x-5">
